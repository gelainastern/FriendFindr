...
class CustomTabBar: UIView {
    ...
    func createTabBarItemSelectionOverlay(_ containers: [CGRect]) {
        ...
        let overlayColors = [UIColor.red, UIColor.orange, UIColor(red: 0.2, green: 0.5, blue: 0.25, alpha: 1.0), UIColor.purple]
    ...
    func createTabBarItemSelectionOverlayMask(_ containers: [CGRect]) {
        ...
        leftMask.backgroundColor = UIColor.darkGray
        ...
        rightMask.backgroundColor = UIColor.darkGray
